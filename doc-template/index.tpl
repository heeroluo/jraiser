...
<footer class="footer boundary">
	...
	<div class="footer__content">
		Copyright &copy; 2012-<%=currentYear%> <a href="http://heeroluo.net/" target="_blank">Heero.Luo</a><br />Released under the <a href="https://opensource.org/licenses/MIT" target="_blank">MIT license</a>
	</div>
</footer>
